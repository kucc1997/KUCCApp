...
class EventPage extends HookWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final bvm = Provider.of<BottomNavBarViewModel>(context);

    Future.microtask(() {
      bvm.displayBottomNavBar = false;
    });

    useEffect(() {
      return () {
        Future.microtask(() {
          bvm.displayBottomNavBar = true;
        });
      };
    }, []);
              ...
              child: Stack(
                children: [
                  ...
                  Positioned(
                    ...
                    bottom: 70,
                    child:
                        Button(startingIcon: Icons.star_border_outlined, buttonText: "Interested"),
                  ),
                  Positioned(
                    left: 0.057 * screenWidth,
                    bottom: 20,
